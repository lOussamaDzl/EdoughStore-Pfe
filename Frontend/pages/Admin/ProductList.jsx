  ...
  return (
    <div className="container xl:mx-[9rem] sm:mx-[0]">
      <div className="flex flex-col md:flex-row">
        {<AdminMenu />}
        <div className="md:w-6/12 mx-20 p-3">
          ...
          {imageUrl && (
            <div className="text-center">
              <img
                src={imageUrl}
                alt="product"
                className="block mx-auto max-h-[50px]"
              />
            </div>
          )}
          ...
          <div className="p-3">
            ...
            <button
              ...
              className="py-4 px-10 mt-5 rounded-lg text-lg text-white font-bold bg-[#186F65] hover:bg-[#47988d]"
            >
              Submit
            </button>
          </div>
